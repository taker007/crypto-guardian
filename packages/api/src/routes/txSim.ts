...
import { buildCompliantWarning } from '../services/compliantWarnings';
  ...
  router.post(
    ...
    async (req: Request, res: Response, next: NextFunction) => {
      ...
      try {
        ...
        // Step 5: Build compliant warning message
        const message = buildCompliantWarning({
          verdict: risk.verdict,
          confidence: risk.confidence,
          signals: {
            unlimitedApproval: signals.unlimitedApproval,
            approvals: signals.approvals.map((a) => ({ spender: a.spender, amount: a.amount })),
            ...
            isPermit: signals.isPermit,
            isMulticall: signals.isMulticall,
          },
        });
        ...
        // Step 7: Response (backward-compatible + compliant message)
        res.json({
          ok: true,
          verdict: risk.verdict,
          confidence: risk.confidence,
